...
| Mundane | temporal/phenomenal | 30 | outer sphere, radius 100–155 |
| **Total** | | **83** | |

> Polar construction vertices (single-letter labels at radius 233) are excluded from this listing — they are scaffolding for the 3D projection, not canonical categories.

---

## Plasmàtica · atemporal/foundational layer (27)

Categories at the inner sphere (radius 0–50) — atemporal, foundational expressions. The "PLA" pole of the radial axis (D4-).
...
Disordered, flexible, and useless movement of external concrete reality. Space x time x force (h of Planck). Drive. Automatism. Initiative. Panenergetism. Activity. Maximal Agency. Effort. Absolute action. Facet. Feat. Adventure. Journey. Exploration. Plasmic technique.

### **AKA** — Akasha *(CA: Akaixa)* · coords (x,y,z) = (-27, -30, -27)

Fusion of all transcendent experience in the matrix of all spirits. General subjective state vibrating with the loss of particular consciousness. Fusion. Mysticism of matter. Plasmic mysticism. Universal mystical matrix. Primordial waters.

### **APE** — Apeiron *(CA: Àpeiron)* · coords (x,y,z) = (27, -30, -27)

Inexorably disordered movement of concrete reality. Basic indefinite reality, without limits or law. Subquantum primordial paste. Everything is permitted (Paul). Everything connects with everything. Universal prostitution (A. Breton). Non-violence. Ahimsa (sanscr.). Border man. Transmorality. Bosonic penetrability of matter. Plasmic ethics. Anarchism.
...
### **BOS** — Boson *(CA: Bosó)* · coords (x,y,z) = (50, 0, 0)

Basic vibrating stationary structures. Elementary particle. Boson (particle). Atom. Monad. Quantum (Planck). Wave and vibratory phenomena. Laser. Light matter. Spiritual body.

### **CAS** — Chaos *(CA: Caos)* · coords (x,y,z) = (0, -50, 0)
...
### **CNF** — Confinement *(CA: Confinament)* · coords (x,y,z) = (0, 0, -50)
...
### **FOL** — Madness *(CA: Follia)* · coords (x,y,z) = (-38, 29, 0)

Exalted understanding out of measure. Mind that is beyond conventions and obligations. Madness. Extravagance. Absurdity. Mania. Paroxysm. Hallucination. Exaltation. Euphoria.
...
Microphysical expression with radical scientific imprecision. Uncertainty. Blurriness. Implicit. Disorder. Principles of non-identity, contradiction, and included third (Stefan Lupasco). Infinite. Unpredictability. Infinitesimal. Unconditioned. Unlimited. Indefinition. Unknowable. Copenhagen interpretation. Plasmic logic. Doubt.
...
The boiling force at the heart of all beings. Love in the state of maximum confusion. Transcendent reality in a plasmic state. Orgy. Boiling. Hell. Avernus.

### **ONA** — Wave *(CA: Ona)* · coords (x,y,z) = (35, 0, 35)

Oscillatory movement and exercise of fundamental elastic reality. Special form of vibratory movement. Vibration. Wave mechanics. Microphysics (Schrödinger wave equation, unified field formula). Probability wave. Unpredictability. Statistical law. Interfered or standing waves.

### **ORG** — Orgone *(CA: Orgó)* · coords (x,y,z) = (35, 0, -35)

The virtual seed driving the being. The vital force of elemental seeds. Seed. Self-builder. Self-generator. Self-organizer. Self-convener. Egg. Embryo. Germ. Cause. Origin. Prana (Hindu). Orgone energy. Genetics. Generation. Genealogy.

### **PAS** — Passion *(CA: Passió)* · coords (x,y,z) = (-27, -30, 27)

Disordered, flexible, and useless interior movement of loving or violent concrete reality. Any radically disordered affection of the soul. Cosmic agitation of subjective basis. Emotion. Anger. Hatred. Concupiscence. Libido. Suffering. Passion. Empathy. Sympathy / antipathy. Endopathy. Passivity. Plasmic psyche. Pathos. Pathologies.

### **PRB** — Probability *(CA: Probabilitat)* · coords (x,y,z) = (0, 30, 40)

Referring to what has reasons to happen. Probability calculation. Contingency. Approximation. Eventuality. Estimate. Likelihood. Chance due to ignorance. Average. Mean. Probabilistic laws. Statistics.

### **PRD** — Prodigy *(CA: Prodigi)* · coords (x,y,z) = (38, -29, 0)

Fascinating powers over objects of concrete reality. Strange event that exceeds the limits of what is natural or predictable. Powers. Wonder. Miracle. Admiration. Thaumaturgy. Failure. Dead end.

### **RAR** — Rarity *(CA: Raresa)* · coords (x,y,z) = (38, 29, 0)

What escapes the definition or control of objects. Extravagant performance. Scarcity of something. Anomaly. Abnormality. Irregularity. Surprise. Strangeness (quark particle). Barbarity. Once. Scarcity. Eccentricity. Marginality. Reminiscence. Exception.

### **SLM** — Sublimity *(CA: Sublimitat)* · coords (x,y,z) = (0, 30, -40)

Revelation of perfection. Attaining a degree of insuperable beauty, truth, or goodness: Ideal. Loftiness. Excellence. Eminence. Excelsitude. Olympus. Magnificence. Sovereignty. Superiority. Adoration. Praise. Pride. Zeus. Preeminence. The third heaven. Holiness. Supreme beauty. Martyrdom.

### **TIA** — Tiamat *(CA: Tiàmat)* · coords (x,y,z) = (-27, 30, -27)

The Universal Mother who embraces and sustains us. The ancestral myth of the Mother of gods, humans, life, and things. Providence. Ideal universal mother. Feminine principle. Blind trust. The Primordial Waters (Babylon). No concern. No error. Predestination. Spiritual vision. Plasmic myth.

### **TRB** — Turbulence *(CA: Turbulència)* · coords (x,y,z) = (0, -30, 40)

Practical confusion of the broad concrete reality. Obfuscation of things by mixing with other things. Agitation. Rush. Tumult. Riot. Turmoil. Disturbance. Crisis. Insecurity.

### **TRS** — Transit *(CA: Trànsit)* · coords (x,y,z) = (-35, 0, 35)

Excited interior state of the fecund genius. State of suspension of usual senses during a mystical, hypnotic, spiritualist, inspired session. Inspiration. Medium. Access. History. Euphoria. Epileptic aura. Somnambulism. Automatic writing. The hand of God. The voice of God. Man of God.

## Neutral · mediator/axial layer (26)

Categories at the mediator sphere (radius 60–80). This layer is structured in three sub-tiers:

- **Tier 1 — 6 cardinal axis poles** (gen 1.0): TEO, PRA, FEN, NOU, SUB, OBJ
...
### **ART** — Art *(CA: Art)* · coords (x,y,z) = (-70, 0, 70)

Aesthetic rigorous treatment of changing reality (psychic, interior, and experiential). Creative expression. Reverie. Creation. Poetry. Touch. Precision. Clinical eye. Alteration. Dream. Not just the fine arts, but also: education, medicine, politics, demotics, soul care, judiciary, journalism, etc. Mask. Precision without law. Unconscious mathematics. Asceticism.
...
Common good. Transcendence that challenges the vital attitude. Objective love. Rights and duties. Need. Justice. Natural law.
...
Rules of reason. Deduction. Mathematics. Non-contradictory formal expression. Mathematics. Formula. Calculation. Quantity. Algorithm. Induction. Deduction. Derivation. Inference. Equivalence. Equality. Isomorphism. Ideal speech or language.

### **MIS** — Mysticism *(CA: Mística)* · coords (x,y,z) = (-55, -60, -55)

Spiritual experience of transcendent reality. Subjective love. Ecstasy. Mystery. Contemplation. Dionysian impulse. Initiatory mysteries. Unspeakability. Ineffability. Sacredness. Mystagogies. Parapsychology. Witchcraft. Witchery. Night of the spirit. Transforming union. Spiritual betrothal and marriage. Divine or diabolical possession.

### **MIT** — Mythic *(CA: Mítica)* · coords (x,y,z) = (-55, 60, -55)

Expression or free spiritual delirium. Transcendent narrative. Voice of the soul of the universe. Delirium. Heroism. Epic. Liturgy. Hierarchy. Celebration. Party. Carnival. Prophecy. The feast of fools. Gift of tongues. The imaginary. Cults. Rites.
...
The intimate experience of everyday reality. Games of sets of inner experiences. Sensitivity. Experiences. Intuitions. Affections. Sensations. Volitions. Perceptions. Images. Thoughts. Feelings. Decisions. Actions. Memories. Education. Introspection. Play. Temperance / debauchery. Real, novelistic, cinematic dramas. Please. Interiority. Intimacy.

### **TEC** — Technique *(CA: Tècnica)* · coords (x,y,z) = (55, -60, 55)

Procedure. Tool. Conditions of use of tools. Professional skill. Efficiency. Laws of sets of physical utility. Physics. Rule. Method. Machine. Tool. Experiment. Repetition. Protocol. Pragmatism. Realism. Tricks. Stratagems. Craftsmanship. Trade. Industry. Disciplines. Computing. Electronics.

## Mundana · temporal/phenomenal layer (30)

Categories at the outer sphere (radius 100–155) — temporal, phenomenal expressions. The "MON" pole of the radial axis (D4+).

### **MONpt1** — pt1 *(CA: pt1)* · coords (x,y,z) = (165, 0, -165)

parença nou

### **MONpt2** — pt2 *(CA: pt2)* · coords (x,y,z) = (-165, 0, 165)

parença nou

### **MONpt3** — pt1 *(CA: pt3)* · coords (x,y,z) = (-165, 0, -165)

parença nou

### **MONpt4** — pt4 *(CA: pt4)* · coords (x,y,z) = (165, 0, 165)

parença nou

### **AFI** — Affinity *(CA: Afinitat)* · coords (x,y,z) = (155, 0, 0)

Composition. External extension. Mechanical attraction. Kinship. Fidelity. Stable relationship. Link. Valence. Union. Mixture. Nexus. Engagement. Bond. Articulation. Framework. Closet. Weapon. Coordination. Morphology. Subordination. Pairing. Adjustment. Tuning. Consequence.

### **AGU** — Acuity *(CA: Agudesa)* · coords (x,y,z) = (-110, 0, 110)

Attitude and adequate treatment of mood states. Sharpness of the senses. Acuity of the mind. Intellectual penetration. Sharpness. Vivacity. Alertness. Subtlety. Finesse. Talent. Acuity. Clairvoyance. Personality. Thoroughness. Expertise. Professionalism. Penetration. Skill.
...
Seeing or making see what suits. Skill and wit to deceive or avoid deception. Prudence. Strategy. Tactic. Stratagem. Sagacity. Wit. Arts. Left-handedness. Diplomacy. Roguery. Maneuvering capacity. Fiction. Lie. Artifice.

### **BEL** — Beauty *(CA: Bellesa)* · coords (x,y,z) = (-85, 95, 85)
...
### **COM** — Community *(CA: Comunitat)* · coords (x,y,z) = (-85, -95, 85)

The intimate, flexible, and coordinated experience of everyday reality. Group of people living united voluntarily. Coexistence. Collectivity. College. Society. People. Public information, opinion, decision, will, action. Harmony. Consensus. Municipality. Germania. Brotherhood. Fraternity. Mundane psyche.

### **COS** — Cosmos *(CA: Cosmos)* · coords (x,y,z) = (0, -155, 0)
...
### **ECL** — Ecology *(CA: Ecologia)* · coords (x,y,z) = (85, -95, -85)
...
The concrete experience of reality and the community of spirits. Concrete conjunction of spirits. Concord. Concrete and living universality. Symbiosis. Altruism. Communion of saints (Christian). Mystical body of Christ (Paul). Spiritualism. Mundane mysticism. Fraternity (French Revolution). Tolerance. Consensus. Common soul.

### **EXC** — Exactness *(CA: Exactitud)* · coords (x,y,z) = (0, 0, 155)
...
### **GEN** — Genius *(CA: Geni)* · coords (x,y,z) = (-110, 0, -110)
...
### **OGN** — Organ *(CA: Òrgan)* · coords (x,y,z) = (110, 0, -110)

Being born, generated, self-constituted. Set of elements and functions of a living body. Organism. Organization. Self-construction. Self-organization. Self-convocation. Autarky. Living apparatuses. Living tissues.

### **PCS** — Precision *(CA: Precisió)* · coords (x,y,z) = (0, 93, 123)

Abstraction, separation, or rigorous differentiation by understanding. Criticism. Discernment. Critical sense. Formal rigor. Modification. Mode. Count. Computation. Computing. Sharpness. Anticipation.

### **POL** — Politeness *(CA: Polidesa)* · coords (x,y,z) = (0, -93, 123)

The practical control of the broad present concrete reality. Suitable to the senses and worked with neatness. Skill. Technical rigor. Good workmanship. Having at hand. Good hand. Handyman. Manuality. Manufacture. Neatness. Consideration. Courtesy. Delicacy. Cosmetics. Makeup. Swagger.

### **RGN** — Kingdom *(CA: Regne)* · coords (x,y,z) = (0, -93, -123)

The perfect utopia made concrete reality. Real state of justice, peace, and spiritual happiness. Earthly paradise. Heaven on earth. Success. Eden. Nest. Den. Home. Homeland. Promised land. Liberated territory. Realized utopia. Community of love. Kingdom of heaven.
...
- [`4-axes.md`](4-axes.md) — the four reflective axes
- [`8-root-categories.md`](8-root-categories.md) — Tier 1 axis poles + Tier 2 secondary mediators
- [`12-disciplines.md`](12-disciplines.md) — Tier 3 academic disciplines
- [`fractal-N1-N2.md`](fractal-N1-N2.md) — fractal architecture
