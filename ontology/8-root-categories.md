...
|------|---------------|---------------|------|
| **D1** | **OBJ** *(Object)* | **SUB** *(Subject)* | Cartesian |
| **D2** | **TEO** *(Theory)* | **PRA** *(Practice)* | Cartesian |
| **D3** | **NOU** *(Noumenon)* | **FEN** *(Phenomenon)* | Cartesian |
| **D4** | **PLA** *(Plasma)* | **MON** *(World)* | Radial — *tempeternitat* |

The first three axes (D1, D2, D3) are Cartesian — orthogonal directions in 3D space. The fourth (D4) is **radial**: it is the meta-dimensional axis of *tempeternitat* (time + eternity), operating on every other pole and generating three layers of expression (Plasmàtica / Neutral / Mundana) for each cardinal direction.

See [`4-axes.md`](4-axes.md) for the full account of the axes.
...
MON is the *positive pole of the radial axis D4*. Unlike the other 7 axis poles, MON is **not represented as a single point** in the 3D projection — it is the entire **outer Mundana sphere** (radius 100–155 in the projection, with cardinal vertices at radius 233). The 36 Mundana categories collectively embody the MON pole: the temporal, phenomenal, manifest face of reality.

## What follows from the 8 root categories
...
- [`4-axes.md`](4-axes.md) — the four reflective axes that generate these 8 poles
- [`12-disciplines.md`](12-disciplines.md) — the 12 academic discipline categories
- [`80-categories.md`](80-categories.md) — full listing of all 80 canonical categories
